...
//construtor
	...
	public void enter_firstName(String fName)  {
		...
		JavaBase.sendKeys("FirstName",FirstName, fName,3);
	}
	...
	public void  enter_ContactNumber(String number) {
		JavaBase.sendKeys("contactNumber",contactNumber, number,1);
	}
	...
	public void  numberperson(String numberperson) {
	 ...
	 public void id_proofType(String prooftype) {
	   ...
	   public void id_proofnumber(String profnum) {
		   JavaBase.sendKeys("idProofNumber", idProofNumber,profnum,2);
	    }
...
//		   wait.until( ExpectedCondition.visibilityOfElementLocated(uploadIdproof));
//	   }
